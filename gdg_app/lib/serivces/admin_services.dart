...
class AdminService {
  ...
  Future<Map<String, dynamic>> getAllAdmins({
    ...
    try {
      ...
      final uri =
          Uri.parse('${ApiConstants.baseUrl}/api/v1/admins/administrators')
  ...
  Future<Map<String, dynamic>> registerCoach({
    ...
    try {
      ...
      final uri =
          Uri.parse('${ApiConstants.baseUrl}/api/v1/admins/register-coach');
...
// Add Accept header
      ...
      if (response.body.isNotEmpty) {
        debugPrint(
            'Response body: ${response.body.substring(0, min(300, response.body.length))}');
      }
  ...
  Future<Map<String, dynamic>> registerAthlete({
    ...
    try {
      ...
      final uri = Uri.parse(
          '${ApiConstants.baseUrl}/api/v1/admins/register-organization-athlete');
      ...
      if (schoolWebsite != null)
        request.fields['schoolWebsite'] = schoolWebsite;
      ...
      if (headCoachAssigned != null)
        request.fields['headCoachAssigned'] = headCoachAssigned;
      if (gymTrainerAssigned != null)
        request.fields['gymTrainerAssigned'] = gymTrainerAssigned;
      if (medicalStaffAssigned != null)
        request.fields['medicalStaffAssigned'] = medicalStaffAssigned;
      ...
      request.fields['emergencyContactRelationship'] =
  ...
  Future<Map<String, dynamic>> getOrganizationStats() async {
    try {
      final uri =
          Uri.parse('${ApiConstants.baseUrl}/api/v1/admins/organization-stats');
      ...
      debugPrint(
          'Get organization stats response status: ${response.statusCode}');
      ...
      if (response.statusCode == 200) {
        ...
        return {
          ...
          'message':
              data['message'] ?? 'Organization statistics fetched successfully',
        };
      } else {
        final error = jsonDecode(response.body);
        return {
