...
class _AdminViewPlayersState extends State<AdminViewPlayers> with SingleTickerProviderStateMixin {
  ...
  final List<String> _sortOptions = ['Name (A-Z)', 'Name (Z-A)', 'Sport', 'Age (Youngest)', 'Age (Oldest)'];
  ...
  void _filterPlayers() {
    setState(() {
      _filteredPlayers = _players.where((player) {
        final matchesName = player['name'].toString().toLowerCase().contains(_searchQuery.toLowerCase());
  ...
  void _sortPlayers() {
    switch (_sortBy) {
      case 'Name (A-Z)':
        _filteredPlayers.sort((a, b) => a['name'].toString().compareTo(b['name'].toString()));
        break;
      case 'Name (Z-A)':
        _filteredPlayers.sort((a, b) => b['name'].toString().compareTo(a['name'].toString()));
        break;
      case 'Sport':
        _filteredPlayers.sort((a, b) => a['primarySport'].toString().compareTo(b['primarySport'].toString()));
        break;
      case 'Age (Youngest)':
        _filteredPlayers.sort((a, b) => a['age'].toString().compareTo(b['age'].toString()));
        break;
      case 'Age (Oldest)':
        _filteredPlayers.sort((a, b) => b['age'].toString().compareTo(a['age'].toString()));
        break;
    }
  }
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: _getSportColor(player['primarySport']).withOpacity(0.1),
                                        borderRadius: BorderRadius.circular(12),
                                      ),
                                      child: Text(
                                        player['primarySport'],
                                        style: TextStyle(
                                          color: _getSportColor(player['primarySport']),
                                          fontSize: 12,
                                          fontWeight: FontWeight.w500,
                                        ),
                                      ),
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      player['athleteId'] ?? 'ATH-${index + 1000}',
                                      style: TextStyle(
                                        color: Colors.grey.shade600,
                                        fontSize: 12,
                                      ),
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    image: AssetImage(player['profilePhoto']),
                                    fit: BoxFit.cover,
                                  ),
                                ),
                              ),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      _buildStatItem(
                        ...
                        title: 'Sports',
                        value: _sportFilters.length > 0 ? (_sportFilters.length - 1).toString() : '0',
                      ),
                      _buildStatItem(
  ...
  Widget _buildFilterChip({required String label, required IconData icon, required VoidCallback onPressed}) {
    return Material(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        leading: Icon(
                          _getSportIcon(sport),
                          color: sport == 'All' ? Colors.deepPurple : _getSportColor(sport),
                        ),
...
Widget build(BuildContext context) {
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              background: Stack(
                ...
                children: [
                  ...
                  // Profile image
                  Hero(
                    tag: 'player-avatar-${widget.playerData['id']}',
                    child: Image.asset(
                      widget.playerData['profilePhoto'],
                      fit: BoxFit.cover,
                    ),
                  ),
                        ...
                        Row(
                          children: [
                            Container(
                              padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                              decoration: BoxDecoration(
                                color: _getSportColor(widget.playerData['primarySport']).withOpacity(0.8),
                                borderRadius: BorderRadius.circular(12),
                              ),
                              child: Text(
                                widget.playerData['primarySport'],
                                style: const TextStyle(
                                  color: Colors.white,
                                  fontSize: 12,
                                  fontWeight: FontWeight.w500,
            ...
            actions: [
              ...
              PopupMenuButton<String>(
                ...
                onSelected: (value) {
                  if (value == 'export') {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('Exporting player profile...')),
                    );
          ...
          _buildInfoSection(
            ...
            content: Column(
              children: [
                _buildInfoRow(
                  label: 'Date of Birth',
                  value: widget.playerData['dob'] ?? 'Not available',
                  icon: Icons.cake,
                ),
                _buildInfoRow(
                  label: 'Gender',
                ...
                _buildInfoRow(
                  label: 'Contact',
                  value: widget.playerData['phone'] ?? 'Not available',
                  icon: Icons.phone,
                ),
                _buildInfoRow(
                  label: 'Email',
          ...
          _buildInfoSection(
            ...
            content: Column(
              children: [
                ...
                _buildInfoRow(
                  label: 'Position/Role',
                  value: widget.playerData['playingPosition'] ?? 'Not specified',
                ...
                _buildInfoRow(
                  ...
                  value: widget.playerData['trainingStartDate'] ?? 'Not available',
          ...
          _buildInfoSection(
            ...
            content: Column(
              children: [
                ...
                const Divider(),
                _buildAssignedStaffRow(
                  name: widget.playerData['gymTrainerAssigned'] ?? 'Not assigned',
                  role: 'Gym Trainer',
                  imagePath: 'assets/images/trainer_avatar.png',
                ),
                const Divider(),
                _buildAssignedStaffRow(
                  name: widget.playerData['medicalStaffAssigned'] ?? 'Not assigned',
                  role: 'Medical Staff',
          ...
          _buildInfoSection(
            ...
            content: Column(
              children: [
                ...
                _buildInfoRow(
                  label: 'Phone',
                  value: widget.playerData['emergencyContact'] ?? 'Not available',
                  icon: Icons.phone,
                ),
                _buildInfoRow(
                  label: 'Relationship',
  ...
  Widget _buildAssignedStaffRow({required String name, required String role, required String imagePath}) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 8),
      child: Row(
        children: [
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceAround,
                children: [
                  _buildPerformanceStat('85', 'Consistency', Icons.auto_graph),
          ...
          child: Column(
            children: [
              _buildCoachFeedback(
                ...
                date: 'Mar 5, 2025',
                feedback: 'Showing excellent progress in ball control and passing accuracy. Needs to work on defensive positioning and communication on field.',
                rating: 4,
              ),
              const Divider(),
              _buildCoachFeedback(
                ...
                date: 'Feb 20, 2025',
                feedback: 'Good technical skills displayed during practice matches. Recommend focusing on endurance training to maintain performance throughout full match duration.',
                rating: 3,
              ),
            ],
          ),
          ...
          child: Column(
            children: [
              _buildInjuryItem(
                ...
                details: 'Grade 1 lateral ankle sprain sustained during training. Currently undergoing physiotherapy 3x per week.',
              ...
              _buildInjuryItem(
                ...
                details: 'Minor hamstring strain. Completed rehabilitation program and returned to full training.',
              ...
              _buildInjuryItem(
                ...
                status: 'Resolved',
                statusColor: Colors.green,
                details: 'Impact injury during match. Required ice treatment and short rest period.',
                recoveryProgress: 1.0,
              ),
            ],
          ),
                ...
                trailing: Row(
                  ...
                  children: [
                    IconButton(
                      ...
                      onPressed: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text('Viewing document...')),
                        );
                      },
                    ),
                    IconButton(
          ...
          child: Column(
            children: [
              _buildNotificationItem(
                ...
                message: 'The evening session on Friday has been canceled due to venue maintenance.',
                date: 'Mar 7, 2025',
                isRead: true,
                type: 'cancellation',
              ),
              ...
              _buildNotificationItem(
                title: 'Time Change',
                message: 'Saturday\'s competition has been moved from 8:30 AM to 9:30 AM.',
                date: 'Mar 6, 2025',
                isRead: false,
                type: 'change',
              ),
              ...
              _buildNotificationItem(
                ...
                message: 'A special technical drill session has been added next Monday at 3:00 PM.',
                date: 'Mar 5, 2025',
                isRead: false,
                type: 'addition',
              ),
...
Widget _buildScheduleSection({required String title, required IconData icon, required Widget child}) {
  return Container(
    decoration: BoxDecoration(
      color: Colors.white,
      borderRadius: BorderRadius.circular(16),
          ...
          child: Column(
            children: [
              ListTile(
                ...
                subtitle: const Text('Transfer funds directly to our account'),
          ...
          child: Column(
            children: [
              _buildAssistanceItem(
                ...
                statusColor: Colors.green,
                amount: '₹15,000',
                description: 'Based on outstanding performance in regional championships',
                date: 'Dec 5, 2024',
              ),
              const Divider(),
              _buildAssistanceItem(
              ...
              _buildAssistanceItem(
                ...
                amount: 'Up to ₹50,000',
                description: 'Available for state-level players with 3+ years of training',
