...
class MedicalStaffMakeAnAnnouncement extends StatefulWidget {
  const MedicalStaffMakeAnAnnouncement({super.key});

  @override
  _MedicalStaffMakeAnAnnouncementState createState() =>
      _MedicalStaffMakeAnAnnouncementState();
}

class _MedicalStaffMakeAnAnnouncementState
    extends State<MedicalStaffMakeAnAnnouncement> {
  final _authService = AuthService();
  List<dynamic> _announcements = [];
  final TextEditingController _announcementController = TextEditingController();
  int _nextId = 3; // Assuming the next ID for a new announcement
  String _selectedDrawerItem = medicalStaffMakeAnAnnouncementRoute;
  ...
  final String _currentMedicalStaffName = "Coach Smith";
  final String _currentMedicalStaffId = "coach123";
  ...
  void _addAnnouncement(String announcement) {
    ...
    setState(() {
      _announcements.insert(0, {
        "id": _nextId++,
        "staffName": _currentMedicalStaffName,
        "staffId": _currentMedicalStaffId,
        "announcement": announcement,
        "timestamp": DateTime.now().toIso8601String(),
        "sport": _selectedSport,
        "fromMedical": true, // Flag to identify medical announcements
      });
    });
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
            'Medical announcement posted for ${_selectedSport == "All Sports" ? "all sports" : _selectedSport}!'),
  ...
  // Check if the current medical staff can edit the announcement
  bool _canEditAnnouncement(Map<String, dynamic> announcement) {
    // If the announcement has a staffId field, check it
    if (announcement.containsKey('staffId')) {
      return announcement['staffId'] == _currentMedicalStaffId;
    }

    // For backward compatibility with older data structure
    if (announcement.containsKey('coachId')) {
      return false; // Medical staff can't edit coach announcements
    }

    // For backward compatibility - check staff name
    return announcement.containsKey('staffName') &&
        announcement['staffName'] == _currentMedicalStaffName;
  }
  ...
  Future<bool> _onWillPop(BuildContext context) async {
    ...
    if (shouldLogout) {
      Navigator.pushReplacementNamed(context, medicalStaffHomeRoute);
    }
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Medical Announcements'),
          backgroundColor: Colors.deepPurple,
          elevation: 0,
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: announcement
                                              .containsKey('fromMedical') &&
                                          announcement['fromMedical'] == true
                                      ? Border.all(
