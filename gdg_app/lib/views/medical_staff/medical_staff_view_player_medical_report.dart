...
class _MedicalStaffPlayerReportState extends State<MedicalStaffPlayerReport> {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildMedicalReportSection(
                            ...
                            Icons.favorite,
                            [
                              _buildVitalSignIndicator('Heart Rate',
                                  '${report['restingHeartRate']}', 'bpm',
                                  isNormal: int.parse(report['restingHeartRate']
                                          .toString()) <
                                      80,
                                  reference: "50-80 bpm"),
                              _buildVitalSignIndicator('Blood Pressure',
                                  report['bloodPressure'], 'mmHg',
                                  reference: "90/60 - 120/80 mmHg"),
                              _buildVitalSignIndicator('Oxygen Saturation',
                                  '${report['oxygenSaturation']}', '%',
                                  isNormal: int.parse(report['oxygenSaturation']
                                          .toString()) >=
                                      95,
                                  reference: "95-100%"),
                              _buildVitalSignIndicator('Respiratory Rate',
                                  '${report['respiratoryRate']}', 'breaths/min',
                                  isNormal: int.parse(report['respiratoryRate']
                                          .toString()) <=
                                      20,
                                  reference: "12-20 per minute"),
                              _buildVitalSignIndicator('Body Temperature',
                                  '${report['bodyTemperature']}', '°C',
                                  isNormal: double.parse(
  ...
  Widget _buildVitalSignIndicator(String label, String value, String unit,
      {bool isNormal = true, String? reference}) {
    return Container(
  ...
  Widget _buildTestResultCard(
      String testName, String result, bool isNormal, String date) {
    final Color statusColor = isNormal ? Colors.green : Colors.orange;
