...
class _ViewAnnouncementsState extends State<ViewAnnouncements> with SingleTickerProviderStateMixin {
  String _selectedSport = 'All Sports'; // Changed to include "All Sports" option
  String _searchQuery = '';
  DateTime? _selectedDate;
  bool _showFilters = false; // Toggle for responsive design
  late TabController _tabController;

  final List<String> _sportCategories = ['All Sports', 'Football', 'Basketball', 'Tennis', 'Cricket'];

  final List<Map<String, dynamic>> _announcements = [
    {
      'id': '1',
      'sport': 'Football',
      'announcement': 'Practice session at 5 PM. All players are required to attend on time. Equipment check will be done before the session starts.',
    ...
    },
    {
      'id': '2',
      'sport': 'Basketball',
      'announcement': 'Team meeting at 3 PM to discuss the upcoming tournament strategy. Attendance is mandatory for all team members.',
    ...
    },
    {
      'id': '3',
      'sport': 'Football',
      'announcement': 'Friendly match scheduled against West Side FC on Saturday. All players to report at 9 AM.',
    ...
    },
    {
      'id': '4',
      'sport': 'Cricket',
      'announcement': 'Net practice session changed to 7 AM tomorrow due to expected rain in the afternoon.',
    ...
    },
    {
      'id': '5',
      'sport': 'Tennis',
      'announcement': 'Court maintenance scheduled for this weekend. No practice on Saturday and Sunday.',
  ...
  List<Map<String, dynamic>> get _filteredAnnouncements {
    return _announcements.where((announcement) {
      final matchesSport = _selectedSport == 'All Sports' || announcement['sport'] == _selectedSport;
                      ...
                      Container(
                        ...
                        child: IconButton(
                          icon: Icon(
                            ...
                            color: _selectedDate != null ? Colors.deepPurple : Colors.grey.shade600,
                          ),
                  ...
                  children: [
                    if (_selectedSport != 'All Sports')
                      _buildFilterChip(
                        ...
                        onDeleted: () => setState(() => _selectedSport = 'All Sports'),
                      ),
          ...
          Expanded(
            child: TabBarView(
              ...
              children: [
                ...
                _buildAnnouncementsList(_filteredAnnouncements.where((a) => a['isNew'] == true).toList()),
              ],
            ),
          ),
        ],
                            ...
                            children: [
                              ...
                              Text(
                                isToday
                                    ...
                                    : DateFormat('MMM d, h:mm a').format(announcementTime),
                                style: TextStyle(
                                  fontSize: 12,
                                  color: Colors.grey.shade600,
                                ),
                      ...
                      OutlinedButton.icon(
                        onPressed: () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(content: Text('Contacting coach...')),
                          );
                        },
