...
class CoachMarkSession extends StatefulWidget {
  const CoachMarkSession({super.key});

  @override
  _CoachMarkSessionState createState() => _CoachMarkSessionState();
}
...
class _CoachMarkSessionState extends State<CoachMarkSession> {
    ...
    _sessions = [
      {
        ...
        'description': 'Morning session for football training.',
        'sports': ['Football'],
      ...
      },
      {
        ...
        'description': 'Focused batting practice for the cricket team.',
        'sports': ['Cricket'],
      ...
      },
      {
        ...
        'description': 'Evening session for basketball practice.',
        'sports': ['Basketball'],
      ...
      },
      {
        ...
        'title': 'Cricket Match',
        'description': 'Full-day cricket match.',
        'sports': ['Cricket'],
  ...
  void _addSession(Map<String, dynamic> session) {
    setState(() {
      session['id'] = _sessions.isEmpty ? 1 : (_sessions.map((s) => s['id']).reduce((a, b) => a > b ? a : b) + 1);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Mark Sessions'),
      ...
      drawer: CustomDrawer(
        selectedDrawerItem: coachMarkSessionRoute,
      ...
      floatingActionButton: _calendarFormat == CalendarFormat.month ? FloatingActionButton(
        onPressed: () {
          setState(() {
            _calendarFormat = CalendarFormat.week;
          });
...
class SessionCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final List<String> sports = List<String>.from(session['sports']);
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Icon(
                    _getIconForSport(sports.first),
                    color: _getSportColor(sports.first),
                    size: 24,
                  ),
                ),
                ...
                Wrap(
                  ...
                  children: sports.map((sport) {
                    return Chip(
                      ...
                      backgroundColor: _getSportColor(sport).withOpacity(0.1),
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(20),
                        side: BorderSide(
...
class _AddSessionDialogState extends State<AddSessionDialog> {
  ...
  final List<String> _sports = ['Football', 'Basketball', 'Cricket', 'Badminton', 'Tennis'];
