...
class _InvitationsViewState extends State<InvitationsView> with SingleTickerProviderStateMixin {
  List<Map<String, dynamic>> _invitations = [
    {
      ...
      'date': '2023-04-15',
      'type': 'Event',
      'message': 'We would like to invite you to sponsor our annual cricket championship tournament which attracts over 500 participants from across the region.',
      'isRead': false,
    },
    {
      ...
      'date': '2023-04-12',
      'type': 'Partnership',
      'message': 'As an Olympic gold medalist, I am looking for sponsors for my upcoming athletics clinic for underprivileged youth.',
      'isRead': true,
    },
    {
      ...
      'date': '2023-04-10',
      'type': 'Charity',
      'message': 'Our annual charity tournament raises funds for sports equipment for schools in low-income areas. We invite you to be a title sponsor for this noble cause.',
      'isRead': false,
    },
    {
      ...
      'date': '2023-04-08',
      'type': 'Season',
      'message': 'We are looking for sponsors for our upcoming basketball season which includes 24 teams and over 300 games with media coverage.',
      'isRead': true,
    },
    {
      ...
      'date': '2023-04-05',
      'type': 'Tournament',
      'message': 'Our junior championship showcases the next generation of tennis stars. We offer prominent branding opportunities throughout the venue and broadcast.',
      'isRead': false,
    },
  ];
  ...
  final List<String> _filterOptions = ['All', 'Unread', 'Event', 'Partnership', 'Tournament', 'Charity'];
  ...
  void _applyFilters() {
    setState(() {
      _filteredInvitations = _invitations.where((invitation) {
        ...
        bool matchesQuery = invitation['name']!.toLowerCase().contains(_searchQuery.toLowerCase()) ||
               invitation['subject']!.toLowerCase().contains(_searchQuery.toLowerCase());
  ...
  void _toggleReadStatus(int index) {
    ...
    setState(() {
      ...
      if (mainIndex != -1) {
        ...
        _filteredInvitations[index]['isRead'] = _invitations[mainIndex]['isRead'];
      }
    });
  }
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: _getTypeColor(invitation['type']).withOpacity(0.5),
                      ),
                    ),
                    child: Text(
                      invitation['type'],
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text('Accepted invitation from ${invitation['name']}'),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    _buildStatCard(
                      'Unread',
                      _invitations.where((inv) => inv['isRead'] == false).length.toString(),
                    ...
                    _buildStatCard(
                      ...
                      _tabController.index == 0 ? Icons.new_releases : Icons.archive,
                      Colors.white,
                    ),
                  ],
                ),
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      const SizedBox(height: 8),
                                      Text(
                                        _truncateText(invitation['message'], 80),
                                        style: TextStyle(
                                          fontSize: 14,
                                          color: Colors.grey.shade600,
                                          height: 1.3,
