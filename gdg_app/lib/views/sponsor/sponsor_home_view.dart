...
class _SponsorHomeViewState extends State<SponsorHomeView> with SingleTickerProviderStateMixin {
  List<dynamic> _newsArticles = [];
  List<String> _sports = ['cricket', 'football', 'badminton', 'tennis', 'basketball'];
      ...
      child: Card(
        ...
        child: Column(
          ...
          children: [
            ...
            // Simplified footer
            Padding(
              padding: const EdgeInsets.fromLTRB(12, 0, 12, 8), // Reduced padding
              child: Row(
                children: [
                  Icon(
