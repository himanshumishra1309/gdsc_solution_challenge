...
class _TrainerHomePageState extends State<TrainerHomePage> {
  ...
  String _searchQuery = '';
  String _selectedDrawerItem = trainerHomeRoute;
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Gym Trainer Dashboard'),
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      _buildStatCard(
                          'Training Plans',
                          '${(_filteredPlayers.length * 0.8).round()}',
                          Icons.fitness_center,
                          Colors.green),
                      _buildStatCard(
                          'Recovery Plans',
                          '${(_filteredPlayers.length * 0.3).round()}',
                          Icons.healing,
                          Colors.orange),
                    ],
                  ),
          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                ...
                runSpacing: 8,
                children: [
                  _buildStatBadge('Strength: 85%', Icons.fitness_center),
                  _buildStatBadge(player['fitnessStatus'] ?? 'Active',
                      Icons.directions_run),
                  _buildStatBadge(
                      'Last Training: 2d ago', Icons.calendar_today),
                ],
              ),
            ],
          ),
...
class _PlayerProfileWrapperState extends State<PlayerProfileWrapper>
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            _showTrainerQuickActions(context);
          },
          backgroundColor: Colors.deepPurple,
  ...
  void _showTrainerQuickActions(BuildContext context) {
      ...
      child: Column(
        ...
        children: [
          ...
          _buildActionItem(
            ...
            onTap: () {
              Navigator.pop(context);
              // TODO: Navigate to training plan form
            },
          ),
          _buildActionItem(
            icon: Icons.monitor_weight,
            title: 'Log Fitness Metrics',
            onTap: () {
              Navigator.pop(context);
              // TODO: Navigate to fitness metrics form
            },
          ),
          _buildActionItem(
          ...
          _buildActionItem(
            ...
            title: 'Mental Training Program',
            onTap: () {
              Navigator.pop(context);
              // TODO: Navigate to mental training form
            },
          ),
        ],
      ),
