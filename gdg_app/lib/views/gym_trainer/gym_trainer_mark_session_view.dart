...
class TrainerMarkSession extends StatefulWidget {
  const TrainerMarkSession({super.key});

  @override
  _TrainerMarkSessionState createState() =>
      _TrainerMarkSessionState();
}

class _TrainerMarkSessionState extends State<TrainerMarkSession> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: CustomDrawer(
        selectedDrawerItem: trainerMarkSessionRoute,
