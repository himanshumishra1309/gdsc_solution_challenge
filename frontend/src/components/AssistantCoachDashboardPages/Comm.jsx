...
const Communication = () => {
  const [messages, setMessages] = useState([
    { sender: "Coach Raj", text: "You have been assigned team A." },
    { sender: "Assistant Coach Rajesh", text: "Thanks coach, looking forward to assist the team!" },
  ]);
  ...
  const groups = ["Athletes", "Coaches", "Gym Trainers", "Medical Staff"];
