...
const Communication = () => {
  const [messages, setMessages] = useState([
    { sender: "Coach Raj", text: "Hello team, great practice today!" },
    { sender: "Athlete Ravi", text: "Thanks coach, looking forward to the next session!" },
  ]);
  ...
  const groups = ["Athletes", "Assistant Coaches", "Gym Trainers", "Medical Staff"];
