      ...
      <div className={`relative w-[660px] max-w-full min-h-[550px] bg-white rounded-3xl shadow-2xl overflow-hidden transition-all duration-1000 ${isActive ? "active" : ""}`}>
        ...
        <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center">
          ...
          <div className={`w-1/2 h-full flex flex-col items-center justify-center px-10 transition-all duration-1000 ${isActive ? "opacity-0" : "opacity-100"}`}>
            <h1 className="text-2xl font-semibold text-gray-800">Admin Sign Up</h1>
            ...
            <input type="text" placeholder="Admin Name" className="mt-5 p-1 w-full bg-gray-200 rounded-md outline-none focus:ring-2 focus:ring-green-500" required />
        ...
        <div className={`absolute top-0 left-1/2 w-1/2 h-full flex items-center justify-center bg-green-700 text-white transition-all duration-1000 ${isActive ? "-translate-x-full rounded-tr-3xl rounded-br-3xl" : "rounded-tl-3xl rounded-bl-3xl"}`}>
          <div className="text-center">
            <h1 className="text-2xl font-semibold">{isActive ? "Welcome Back!" : "Hello Admin!"}</h1>
